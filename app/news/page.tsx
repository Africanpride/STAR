...
export default async function ArticlesPage() {
  const baseUrl: string = process.env.NEXT_PUBLIC_BASE_URL || ''; // Import the base URL from .env or default to empty string
  console.log(baseUrl); // Log the base URL for debugging

  try {
    const res = await fetch(`${baseUrl}/api/articles/`, { // Modify the URL to include the base URL
      method: 'GET',
      headers: {
